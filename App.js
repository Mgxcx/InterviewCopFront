  ...
  return (
    <NavigationContainer>
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        ...
        {/* <Stack.Screen name="InterviewScreen2" component={InterviewScreen2} />
        <Stack.Screen name="InterviewScreen3" component={InterviewScreen3} />
        <Stack.Screen name="InterviewScreen4" component={InterviewScreen4} />
        <Stack.Screen name="InterviewScreen5" component={InterviewScreen5} />
        <Stack.Screen name="InterviewScreen6" component={InterviewScreen6} />
        <Stack.Screen name="InterviewScreen7" component={InterviewScreen7} />
        <Stack.Screen name="InterviewScreen8" component={InterviewScreen8} />
        <Stack.Screen name="InterviewScreen9" component={InterviewScreen9} />
        <Stack.Screen name="InterviewScreenResult" component={InterviewScreenResult} /> */}
      </Stack.Navigator>
    </NavigationContainer>
  );
}
